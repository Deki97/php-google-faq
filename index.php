...
<body>
    ...
    <?php 
        $faq = [
            'oblio' => [
                'domanda' => 'Come state implementando la recente <a href="">decisione della Corte di giustizia dell\'Unione europea</a> (CGUE) relativa al diritto all\'oblio?',
            ...
            'paese' => [
                ...
                'risposta' => 'Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<br>
